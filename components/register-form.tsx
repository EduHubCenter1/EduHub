...
export function RegisterForm({
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    if (result.success) {
      toast({ title: "Registration Successful", description: result.message || "Please check your email to confirm your account." });
      router.push("/login");
    } else {
